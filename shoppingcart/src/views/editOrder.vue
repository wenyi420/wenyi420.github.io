<template>
  <div>
    ...
    <div class="editList">
      <b-container fluid>
        <b-row class="my-3">
          <b-col sm="2" lg="1" class="inputLabel">
            <label>姓名</label>
          </b-col>
          <b-col sm="6">
            <b-form-input id="name" :value="orderData.name"></b-form-input>
          </b-col>
        </b-row>
        <b-row class="my-3">
          <b-col sm="2" lg="1" class="inputLabel">
          ...
          <b-col sm="6">
            <b-form-input id="phone" :value="orderData.phone"></b-form-input>
          </b-col>
        </b-row>
        <b-row class="my-3">
          <b-col sm="2" lg="1" class="inputLabel">
          ...
          <b-col sm="6">
            <b-form-input id="email" :value="orderData.email"></b-form-input>
          </b-col>
        </b-row>
        <b-row class="my-3">
          <b-col sm="2" lg="1" class="inputLabel">
          ...
          <b-col sm="6" class="radio-content">
            <b-form-radio
              class="radio-item"
      ...
      <div class="btn-list">
        <b-button class="btn" variant="secondary" @click="goToBack"
          >返回</b-button
        >
        <b-button class="btn" variant="success" @click="editUpdate"
          >送出</b-button
        >
      </div>
    </div>
